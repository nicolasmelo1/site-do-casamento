...
export default function Countdown() {
  ...
  return (
    <div className="flex flex-row justify-center items-center w-full cursor-pointer mt-6 md:mt-2">
      <div className="flex flex-row justify-center items-center md:w-full flex-nowrap">
        <div className="flex flex-col justify-center items-center w-24 h-24 sm:w-20 sm:h-20 bg-gray-400 rounded-md p-3 mr-3 md:mr-2 md:m-2">
